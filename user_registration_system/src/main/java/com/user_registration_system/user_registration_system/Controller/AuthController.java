...
public class AuthController {
    ...
    public String users(Model model){
        ...
        return "users"; //user.html網頁 ->接著要建立users.html
    }
        //訪問users頁面時又給我一直導去login頁面，問題是這頁我也還沒寫啊???然後最後這個問題又自己好了

    //7.顯示登入頁面
    @GetMapping("/login")
    public String login(Model model){
        return "login"; //login.html網頁 ->接著要建立login.html
    }

//接著要去建立AppConfig.java
